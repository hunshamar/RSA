...
funcp funcTab[3] = {(funcp)execute_50, (funcp)execute_49, (funcp)vhdl_transfunc_eventcallback};
const int NumRelocateId= 3;

void relocate(char *dp)
{
	iki_relocate(dp, "xsim.dir/ALU_tb_behav/xsim.reloc",  (void **)funcTab, 3);
	iki_vhdl_file_variable_register(dp + 3872);
	iki_vhdl_file_variable_register(dp + 3928);
