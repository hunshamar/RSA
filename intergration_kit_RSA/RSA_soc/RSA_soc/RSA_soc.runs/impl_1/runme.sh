...
HD_PWD='C:/Users/asgei/Desktop/RSA/intergration_kit_RSA/RSA_soc/RSA_soc/RSA_soc.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log RSA_soc_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source RSA_soc_wrapper.tcl -notrace
