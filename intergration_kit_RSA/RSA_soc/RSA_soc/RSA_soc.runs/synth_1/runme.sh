...
HD_PWD='C:/Users/asgei/Desktop/RSA/intergration_kit_RSA/RSA_soc/RSA_soc/RSA_soc.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RSA_soc_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RSA_soc_wrapper.tcl
