...
HD_PWD='C:/Users/asgei/Desktop/RSA/intergration_kit_RSA/RSA_soc/RSA_soc/RSA_soc.runs/rsa_soc_rsa_dma_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rsa_soc_rsa_dma_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rsa_soc_rsa_dma_0.tcl
