...
HD_PWD='C:/Users/asgei/Desktop/RSA/intergration_kit_RSA/RSA_accelerator/RSA_accelerator/RSA_accelerator.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RSA_accelerator.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RSA_accelerator.tcl
